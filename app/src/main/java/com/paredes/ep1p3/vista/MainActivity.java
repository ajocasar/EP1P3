...
import com.paredes.ep1p3.controlador.AdaptadorSpinner;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(getApplicationContext(), "Le falta la fotografia", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public boolean Validar()
    {
        ...
        {
            txtDescripcion.setError("Le falta una descripcion");
            retorno = false;
        }
        if(cant.isEmpty())
        {
            txtCantidad.setError("Le falta la cantidad");
            retorno = false;
        }
    ...
    {
        byteArray = new byte[0];
        foto.setImageResource(R.drawable.farmacia);
    ...
    private void Guardar() {
        ...
        valores.put(Transacciones.periodo, txtPeriodo.getText().toString());
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == PETICION_ACCESO_CAM){
            ...
            Toast.makeText(getApplicationContext(), "Permisos de acceso", Toast.LENGTH_LONG).show();
        }
    }
